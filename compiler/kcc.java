...
public class kcc {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Configure the BytecodeGenerator with the class name derived from outputFile
            ...
            bytecodeGenerator.finalizeMainMethod(); // Finalize the main method bytecode generation
            byte[] bytecode = bytecodeGenerator.getBytecode(); // Retrieve the generated bytecode
